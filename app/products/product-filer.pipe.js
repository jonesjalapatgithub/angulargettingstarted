...
var ProductFilterPipe = (function () {
    ...
    ProductFilterPipe.prototype.transform = function (value, filterBy) {
        filterBy = filterBy ? filterBy.toLocalLowerCase() : null;
        return filterBy ? value.filter(function (product) {
            return product.productName.toLocalLowerCase().indexOf(filterBy) != -1;
        }) : value;
    };
...
//# sourceMappingURL=product-filer.pipe.js.map